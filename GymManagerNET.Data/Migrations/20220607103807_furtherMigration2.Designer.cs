...
namespace GymManagerNET.Data.Migrations
{
    ...
    [Migration("20220607103807_furtherMigration2")]
    partial class furtherMigration2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymManagerNET.Core.Models.Users.DefaultEmployee", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GymManagerNET.Core.Models.Users.DefaultEmployee", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
